...
export const ShowPassword: FC<IconsProps> = ({color = '#000', size = 32}) => {
  return (
    <SVG x="0px" y="0px" viewBox="0 0 512 512" width={size} height={size}>
      ...
      <Path
        fill={color}
        d="M255.995 170.662c-47.061 0-85.333 38.272-85.333 85.333s38.272 85.333 85.333 85.333 85.333-38.272 85.333-85.333-38.272-85.333-85.333-85.333zm0 149.334c-35.285 0-64-28.715-64-64s28.715-64 64-64 64 28.715 64 64-28.715 64-64 64z"
      />
    </SVG>
  );
};
